...
int     spacing;
{
	...
	sp->var = var;
      ...
      (void) install_command(sp->name, change_display, DISPLAYOPTIONS,
    								(int *) sp);
      (void) install_command(sp->name, do_update_template, DISPLAYMENU,
    								(int *) sp);
    }
    else {
        sp->var = NULL;
...
char   *name;
{
    ...
    (void) install_template(name, LABEL, NULL, template_level, 
...
char   *name;
{
    ...
    (void) install_template(name, LABEL_ARRAY, template_level, varname, 
...
char   *name;
{
    ...
    (void) install_template(name, VARIABLE, template_level, varname, 
...
char   *name;
{
    ...
    (void) install_template(name, FLOATVAR, template_level, varname, 
	    template_x, template_y, TRUE, 0,0,0, 0, dig, scale,0);
}
