...
init_pats(pairs) int pairs; {
    ...
    (void) install_var("npatterns", Int,(int *) & npatterns, 0, 0,SETENVMENU);
    (void) install_var("maxpatterns",Int,(int *) &maxpatterns,0,0,SETENVMENU);
    (void) install_var("ipattern", PVfloat,(int *) ipattern, 0, 0,SETENVMENU);
    if (pairs) 
      (void) install_var("tpattern", PVfloat,(int *) tpattern,0,0,SETENVMENU);
    (void) install_var("pname",Vstring,(int *) pname, 0, 0, SETENVMENU);
    (void) install_var("cpname", String,(int *) cpname, 0, 0, SETSVMENU);
