...
init_display() {
    ...
    (void) install_command("screen",save_screen, SAVEMENU,(int *) NULL);
    (void) install_var("standout", Int,(int *) & stand_out,0,0, 
    							DISPLAYOPTIONS);
    (void) install_var("dlevel", Int,(int *) &Display_level, 0, 0,SETPCMENU);
    (void) install_var("slevel", Int,(int *) &Save_level, 0, 0, SETPCMENU);
}
